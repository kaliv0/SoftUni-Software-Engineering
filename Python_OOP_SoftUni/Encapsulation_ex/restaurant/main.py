from Encapsulation_ex.restaurant.project.beverages.beverage import Beverage
from Encapsulation_ex.restaurant.project.foods.soup import Soup
from Encapsulation_ex.restaurant.project.product import Product
